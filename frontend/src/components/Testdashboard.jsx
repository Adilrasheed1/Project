...
function TestDashboard({ setSelectedExam }) {
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="max-w-60 h-10 m-2 flex rounded-3xl bg-[#9fd200] text-white items-center font-serif">
            <IndianRupee size={32} color="black" className="bg-white  rounded-3xl p-1 ml-1"/>
            <h4 className="text-sm px-2 font-bold">FREE MOCK TESTS </h4>
      </div>


      <div className="bg-[#eeeff1] rounded-3xl p-4 md:p-6 mt-4 mb-4">
      ...
      {/* SECTION 2 */}
       ...
       <div className="max-w-60 h-10 m-2 flex rounded-3xl bg-[#165EE7] text-white items-center font-serif">
            <Cctv size={32} color="black" className="bg-white  rounded-3xl p-1 ml-1"/>
