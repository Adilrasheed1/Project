...
<div class="mb-20"><LoginHead msg={props.msg} /></div>
        <div className="bg-gray-700 w-130 h-80 ml-50 flex justify-center flex-col  pl-20 rounded-lg border-1 border-gray-500"><label for="input-9" className="block text-sm font-medium text-white">Email</label>
        ...
        <label for="input-9" className="block text-sm font-medium text-white">Password</label>
